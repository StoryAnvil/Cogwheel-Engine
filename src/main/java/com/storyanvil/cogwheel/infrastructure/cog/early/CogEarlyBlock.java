...
public class CogEarlyBlock implements CogPropertyManager{
    private static final EasyPropManager MANAGER = new EasyPropManager("earlyblock", manager -> {
    ...
    public void register(DeferredRegister<Block> blocks) {
