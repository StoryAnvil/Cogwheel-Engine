...
public record DevInsertLine(ResourceLocation lc, int lineBefore, String contents) implements StoryPacket {
    public static final StoryCodec<DevInsertLine> CODEC = StoryCodecBuilder.build(
            StoryCodecBuilder.Prop(DevInsertLine::lc, StoryCodecs.RESOURCE_LOC),
            StoryCodecBuilder.Integer(DevInsertLine::lineBefore),
            StoryCodecBuilder.String(DevInsertLine::contents),
            DevInsertLine::new
    );
