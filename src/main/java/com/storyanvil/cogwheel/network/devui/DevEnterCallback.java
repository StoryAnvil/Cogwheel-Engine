...
public record DevEnterCallback(ResourceLocation lc, String typed, DevEditorUserDelta delta) implements StoryPacket {
    public static final StoryCodec<DevEnterCallback> CODEC = StoryCodecBuilder.build(
            StoryCodecBuilder.Prop(DevEnterCallback::lc, StoryCodecs.RESOURCE_LOC),
            StoryCodecBuilder.String(DevEnterCallback::typed),
            StoryCodecBuilder.Prop(DevEnterCallback::delta, DevEditorUserDelta.CODEC),
