...
public class CogwheelAPI {
    ...
    public static void fireEvent(Identifier event, ScriptStorage storage) {
        CogScriptEnvironment.dispatchEventGlobal(event, storage);
    }

    /**
     * Runs CogScript(aka {@link DispatchedScript}) by Identifier
     * <br>
     ...
     */
    @Api.Stable(since = "2.0.0")
    public static void runScript(Identifier rl) {
     ...
     */
    @Api.Stable(since = "2.0.0")
    public static void runScript(Identifier rl, ScriptStorage storage) {
     ...
     */
    @Api.Stable(since = "2.0.0")
    public static void registerDefaultScriptVariables(@NotNull String name, @NotNull Function<DispatchedScript, CGPM> f) {
