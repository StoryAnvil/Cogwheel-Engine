...
public class DWTabbedView extends DevWidget {
    ...
    public void openAndSelect(Tab tab) {
        tabs.add(0, tab);
        tab.compute(this);
        tab.resize(MinecraftClient.getInstance(), ui().screenWidth, ui().screenHeight);
        selected = tab;
    }
    ...
    public void resize(@NotNull MinecraftClient minecraft, int width, int height) {
        ...
        textY = tabScrollerBottom - 2 - ui().font.fontHeight;
    ...
    public abstract static class Tab extends DevWidget {
        ...
        public void compute(@NotNull DWTabbedView view) {
            tabWidth = view.ui().font.getWidth(getName()) + 10;
