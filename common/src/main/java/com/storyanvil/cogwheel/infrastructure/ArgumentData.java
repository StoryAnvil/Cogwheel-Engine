...
public class ArgumentData {
    ...
    public static @NotNull ArgumentData of(@NotNull String str, DispatchedScript script) {
        ...
        for (int i = 0; i < managers.length; i++) {
            managers[i] = CGPM.noNull(CogwheelRegistries.expressionHandler(expressions.get(i), script, false).getB());
        }
        return new ArgumentData(managers, str, script);
    }

    public static @NotNull ArgumentData of(DispatchedScript script, CGPM a1) {
        return new ArgumentData(new CGPM[]{a1}, null, script);
    }
    public static @NotNull ArgumentData of(DispatchedScript script, CGPM a1, CGPM a2) {
        return new ArgumentData(new CGPM[]{a1, a2}, null, script);
    }
    public static @NotNull ArgumentData of(DispatchedScript script, CGPM a1, CGPM a2, CGPM a3) {
        return new ArgumentData(new CGPM[]{a1, a2, a3}, null, script);
    }
    public static @NotNull ArgumentData of(DispatchedScript script, CGPM... a) {
