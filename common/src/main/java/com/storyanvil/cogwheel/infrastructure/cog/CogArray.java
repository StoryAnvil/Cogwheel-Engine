...
public class CogArray implements CGPM, ForEachManager {
    ...
    public static @NotNull CogArray getInstance(ArrayList<CGPM> t) {
        return new CogArray(t);
    }
    @Contract("_ -> new") @Api.Stable(since = "2.0.0")
    public static <Q extends CGPM> @NotNull CogArray getInstance(List<Q> t) {
        return new CogArray(new ArrayList<>(t));
    }
    @Contract("_ -> new") @Api.Stable(since = "2.0.0")
    public static <Q extends CGPM> @NotNull CogArray getInstance(@NotNull Iterable<Q> t) {
        ArrayList<CGPM> list = new ArrayList<>();
        for (Q q : t) {
            list.add(q);
        }
    ...
    @Contract("_ -> new") @Api.Stable(since = "2.0.0")
    public static <Q extends CGPM> @NotNull CogArray getInstance(Q q) {
        ArrayList<CGPM> list = new ArrayList<>();
        list.add(q);
        return new CogArray(list);
    }
